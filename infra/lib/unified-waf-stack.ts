...
export interface UnifiedWafStackProps extends cdk.StackProps {
  /** 本家 (rou39.com) */
  domainName: string;
  /** uraneko.rou39.com */
 ...
 */
export class UnifiedWafStack extends cdk.Stack {
  public readonly webAclArn: string;

  constructor(scope: Construct, id: string, props: UnifiedWafStackProps) {
